@echo off
REM ============================================================
REM Auto-validation launcher for ZCode.
...
if not exist "%PROJECT_ROOT%\_runtime_cache\daily_status" mkdir "%PROJECT_ROOT%\_runtime_cache\daily_status" >nul 2>&1

echo ============================================================
echo   ZCode Auto Validation Launcher
echo ============================================================
echo   PROJECT_ROOT = %PROJECT_ROOT%
echo   PYEXE        = %PYEXE%
echo ============================================================
"%PYEXE%" "%PROJECT_ROOT%\scripts\auto_validation.py" %*
set "RC=%ERRORLEVEL%"
echo.
