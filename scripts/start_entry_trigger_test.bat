@echo off
REM ============================================================
REM Skill Auto-Trigger Test launcher.
REM NOTE: ALL comments must be plain ASCII English. cmd.exe parses
REM .bat files with system ANSI CP (CP936 on Chinese Windows); UTF-8
...
echo ============================================================
echo   Skill Auto-Trigger Test (BAT Launcher)
echo ============================================================
echo   PROJECT_ROOT = %PROJECT_ROOT%
echo   PYEXE        = %PYEXE%
echo ============================================================
"%PYEXE%" "%PROJECT_ROOT%\scripts\entry_trigger_test.py"
set "RC=%ERRORLEVEL%"
echo.
